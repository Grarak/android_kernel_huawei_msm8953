...
/********* DMD NUMBER FOR LCD and GPU BEGIN ********/
/** keep consistent with "device_state_monitor.conf" file **/
#define DSM_LCD_MIPI_ERROR_NO	(20100)
#define DSM_LCD_TE_TIME_OUT_ERROR_NO	(20101)
#define DSM_LCD_STATUS_ERROR_NO	(20102)
#define DSM_LCD_MDSS_MDP_GPU_ERROR_NO	(20103)
#define DSM_LCD_OTP_ERROR_NO		(20104)
...
#define DSM_LCD_ESD_RESET_ERROR_NO	(20109)
...
#define DSM_LCD_MDSS_VSP_VSN_ERROR_NO	(20115)
...
#define DSM_GPU_HANG_ERROR_NO	(20150)
#define DSM_GPU_PAGE_FAULT_ERROR_NO		(20151)
#define DSM_GPU_SNAPSHOT_LOG_NO	(20152)
/********* DMD NUMBER FOR LCD and GPU END ********/
...
#define DSM_CAMERA_OTP_I2C_ERR (DSM_CAMERA_ERROR + 5)
...
//#define DSM_CAMERA_FD_LEAK_ERR (DSM_CAMERA_ERROR + 31)
//#define DSM_CAMERA_SENSOR_INIT_SESSION_FAIL (DSM_CAMERA_ERROR + 32)
//#define DSM_CAMERA_SESSION_ID_MATCH_FAIL (DSM_CAMERA_ERROR + 33)
//#define DSM_CAMERA_REPROCESS_PARAM_ERROR (DSM_CAMERA_ERROR + 34)
//#define DSM_CAMERA_MCT_PIPELINE_SET_FAIL (DSM_CAMERA_ERROR + 35)
//#define DSM_CAMERA_INVALID_POLL_FD (DSM_CAMERA_ERROR + 36)
//#define DSM_CAMERA_START_CHANNEL_NO_BUF (DSM_CAMERA_ERROR + 37)
#define DSM_CAMERA_BUF_MANAGER_NO_BUF (DSM_CAMERA_ERROR + 38)
#define DSM_CAMERA_ISP_REQUEST_HAL_BUF_FAIL (DSM_CAMERA_ERROR + 39)
#define DSM_CAMERA_ISP_REQUEST_BUF_UPDATE_FAIL (DSM_CAMERA_ERROR + 40)
//#define DSM_CAMERA_CPP_INPUT_PARAMS_ERROR (DSM_CAMERA_ERROR + 41)
//#define DSM_CAMERA_CPP_OUTPUT_PARAMS_ERROR (DSM_CAMERA_ERROR + 42)
#define DSM_CAMERA_ISPIF_PORT_ERROR (DSM_CAMERA_ERROR + 43)
#define DSM_CAMERA_ISPIF_MODULE_NOT_FOUND (DSM_CAMERA_ERROR + 44)
#define DSM_CAMERA_ISPIF_CFG_ERROR (DSM_CAMERA_ERROR + 45)
#define DSM_CAMERA_FOCUS_NOT_DONE (DSM_CAMERA_ERROR + 46)
#define DSM_CAMERA_OIS_ACC_FAIL (DSM_CAMERA_ERROR + 47)
#define DSM_CAMERA_OIS_CHECK_FAIL (DSM_CAMERA_ERROR + 48)
#define DSM_CAMERA_OIS_INIT_FAIL (DSM_CAMERA_ERROR + 49)
#define DSM_CAMERA_OIS_VIBRATE_FAIL (DSM_CAMERA_ERROR + 50)
#define DSM_CAMERA_SENSOR_INIT_FAIL (DSM_CAMERA_ERROR + 51)
#define DSM_CAMERA_SENSOR_SET_RESOLUTION_FAIL (DSM_CAMERA_ERROR + 52)
#define DSM_CAMERA_SENSOR_APPLY_EXPOSURE_FAIL (DSM_CAMERA_ERROR + 53)
#define DSM_CAMERA_SENSOR_START_STOP_STREAM_FAIL (DSM_CAMERA_ERROR + 54)
#define DSM_CAMERA_EEPROM_CALIBRATE_FAIL (DSM_CAMERA_ERROR + 55)
...
#define DSM_FINGERPRINT_WAIT_FOR_FINGER_ERROR_NO	(21600)
#define DSM_FINGERPRINT_CAPTURE_IMAGE_ERROR_NO	(21601)
#define DSM_FINGERPRINT_IDENTIFY_ERROR_NO                 (21602)
#define DSM_FINGERPRINT_TEST_DEADPIXELS_ERROR_NO	(21603)
#define DSM_FINGERPRINT_ENROLL_ERROR_NO	             (21604)
#define DSM_FINGERPRINT_REMOVE_TEMPLATE_ERROR_NO	(21605)
#define DSM_FINGERPRINT_ENUMERATE_ERROR_NO		(21606)
#define DSM_FINGERPRINT_MODULE_OPEN_ERROR_NO		(21607)
#define DSM_FINGERPRINT_PROBE_FAIL_ERROR_NO	       (21608)
#define DSM_FINGERPRINT_DIFF_DEADPIXELS_ERROR_NO	(21609)
#define DSM_FINGERPRINT_MANY_DEADPIXELS_ERROR_NO	(21610)
#define DSM_FINGERPRINT_DB_FILE_LOST_ERROR_NO	    (21611)
