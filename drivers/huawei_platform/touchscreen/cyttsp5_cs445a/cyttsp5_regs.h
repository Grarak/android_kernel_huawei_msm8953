...
#define CY_HID_REGULATOR_DELAYED_TIME 200
enum cyttsp5_suspend_resume_state {
	CY_STATE_NONE,
	CY_STATE_RESUME,
	CY_STATE_SUSPEND,
};
...
struct cyttsp5_core_data {
	...
	unsigned int glove_mode_enabled;
