...
static struct touch_settings cyttsp5_sett_param_regs_Carmel_ofilm = {
	.data = (uint8_t *)&cyttsp4_param_regs_Carmel_ofilm[0],
	.size = ARRAY_SIZE(cyttsp4_param_regs_Carmel_ofilm),
	.tag = 0,
};

static struct touch_settings cyttsp5_sett_param_size_Carmel_ofilm = {
	.data = (uint8_t *)&cyttsp4_param_size_Carmel_ofilm[0],
	.size = ARRAY_SIZE(cyttsp4_param_size_Carmel_ofilm),
	.tag = 0,
};
...
static struct touch_settings cyttsp5_sett_param_regs_Carmel_eely = {
	.data = (uint8_t *)&cyttsp4_param_regs_Carmel_eely[0],
	.size = ARRAY_SIZE(cyttsp4_param_regs_Carmel_eely),
	.tag = 0,
};

static struct touch_settings cyttsp5_sett_param_size_Carmel_eely = {
	.data = (uint8_t *)&cyttsp4_param_size_Carmel_eely[0],
	.size = ARRAY_SIZE(cyttsp4_param_size_Carmel_eely),
	.tag = 0,
};
...
static struct touch_settings cyttsp5_sett_param_regs_Carmel_truly = {
	.data = (uint8_t *)&cyttsp4_param_regs_Carmel_truly[0],
	.size = ARRAY_SIZE(cyttsp4_param_regs_Carmel_truly),
	.tag = 0,
};

static struct touch_settings cyttsp5_sett_param_size_Carmel_truly = {
	.data = (uint8_t *)&cyttsp4_param_size_Carmel_truly[0],
	.size = ARRAY_SIZE(cyttsp4_param_size_Carmel_truly),
	.tag = 0,
};
