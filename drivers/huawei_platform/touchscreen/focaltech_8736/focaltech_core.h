...
#define FTS_RESTORE_WORKQUEUE_NAME  "fts_restore_wq"
...
#define FTS_SYSFS_DEBUG 1
#define FTS_CTL_IIC

#define FTS_MAX_RETRY	1

#define ROI_DATA_READ_LENGTH 100
#define ROI_HEAD_DATA_LENGTH 2
#define ROI_DATA_SEND_LENGTH (ROI_DATA_READ_LENGTH-ROI_HEAD_DATA_LENGTH)

// lifengshi not upgrade test. 20160615
...
extern u8 gu_roi;
extern bool gbset_roi;
extern unsigned char global_roi_data[ROI_DATA_READ_LENGTH + 1];
extern int gnFtsTestResult;
extern void fts_get_test_result(char *result_buf, char *rawdata_buf, int buf_size);
/*******************************************************************************
