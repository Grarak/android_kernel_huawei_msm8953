...
#define EC_PORT_ID_QUINARY_MI2S_RX    7
				  ...
				  struct snd_ctl_elem_value *ucontrol)
{
	...
	case EXT_EC_REF_QUIN_MI2S_TX:
       ...
       case EXT_EC_REF_SLIM_1_TX:
		...
		break;
	case EC_PORT_ID_QUINARY_MI2S_RX:
	    msm_route_ext_ec_ref = AFE_PORT_ID_QUINARY_MI2S_RX;
	    state = true;
	    break;
...
static const struct snd_soc_dapm_route intercon[] = {
	...
	{"VOC_EXT_EC MUX", "QUIN_MI2S_RX" , "QUIN_MI2S_RX"},
